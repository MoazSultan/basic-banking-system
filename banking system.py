...
def change_account_name(account_number, new_name):
    ...
    if account_number in accounts:
        old_name = accounts[account_number]['name']
        accounts[account_number]['name'] = new_name
        return f"Account name updated successfully from '{old_name}' to '{new_name}'."
    
    else:
        return "Account number not found. Please check and try again."
    account_number = int(input("Enter the account number: "))
    new_name = input("Enter the new name for the account: ")
